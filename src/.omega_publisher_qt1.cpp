...
bool CE_OO::run(){
    ...
    while (ros::ok())
    {
        ...
        */
        ...
        // gripper variable is not being set! For this another message type with an additional variable has to be used
...
{
    ros::init(argc, argv, "omega_publisher");
    ros::NodeHandle n;
    CE_OO instance(&n);
    instance.run();
}
